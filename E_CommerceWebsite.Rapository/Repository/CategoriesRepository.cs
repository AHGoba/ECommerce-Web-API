...
{
    // Here i'm using <<IUsersRepository>> as when i'm dealing with 
    public class CategoriesRepository : GenericRapository<Categories> , ICategoriesRepository
    {
    
        // If Here i wanna deal with a new CRUD operation so 

        ECommerceContext context;
        public CategoriesRepository(ECommerceContext _ECommerceContextObject) : base(_ECommerceContextObject) //sending an argument to
