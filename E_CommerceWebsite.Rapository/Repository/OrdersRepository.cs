...
namespace Goba.Repository
{
    ...
    public class OrdersRepository :GenericRapository<Orders> , IOrdersRepository
    {
        // If Here i wanna deal with a new CRUD operation so 

        ECommerceContext context;
        public OrdersRepository(ECommerceContext _ECommerceContextObject) : base(_ECommerceContextObject) //sending an argument to
