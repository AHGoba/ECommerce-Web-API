...
{
    // Here i'm using <<IProductsRepository>> as when i'm dealing with high level
    //الفكره كلها هنا انى بعمل جينريك ريبوزاطرى لاى موديل فا لو عوزت مثلا فى مره ازود لموديل كراد اوبريشن معين 
    // ممكن اضيفه هنا لذلك انا محتاج الكونتكست عشان اعمل دا !!
    public class ProductRepository :GenericRapository<Products> , IProductsRepository
    {
        // If Here i wanna deal with a new CRUD operation so 

        ECommerceContext context;
        public ProductRepository(ECommerceContext _ECommerceContextObject) : base(_ECommerceContextObject) //sending an argument to
